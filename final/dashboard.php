...
<?php $EmployeeList[]= $adminDao->EmployeeById($_REQUEST['id']);
       ...
       <ul class="nav menu">
 <li class="active"><a href="<?php echo $siteUrl;?>dashboard-<?php echo $list->id;?>"><em class="fa fa-dashboard">&nbsp;</em> My Profile</a></li>
			<li><a href="<?php echo $siteUrl;?>recent-<?php echo $list->id;?>"><em class="fa fa-calendar">&nbsp;</em> Recent Trips</a></li>
			<li ><a href="<?php echo $siteUrl;?>request-<?php echo $list->id;?>"><em class="fa fa-bar-chart">&nbsp;</em> Request Trips</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			...
			<div class="col-md-2">
				...
				<span class="glyphicon glyphicon-cog" ></span><strong class="qwerty">&nbsp;Settings</strong></div></a></div>
	...
	<div class="row">
		...
		<?php $count++;}}else{echo "<tr><td colspan='9'>No details..</td></tr>";}?>
		  ...
		  <br>
                    ...
                    <div class="desc"><i>Passionate designer</div>
